...
namespace GameLibrary.Mathematics
{
    ...
    public partial struct Float4X4 : System.IEquatable<Float4X4>, IFormattable
    {
        ...
        {
            this.c0 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v);
            this.c1 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v);
            this.c2 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v);
            this.c3 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v);
        }
        ...
        {
            this.c0 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v.c0);
            this.c1 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v.c1);
            this.c2 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v.c2);
            this.c3 = Math.Select(new Float4(SoftFloat.Zero), new Float4(SoftFloat.One), v.c3);
        }
