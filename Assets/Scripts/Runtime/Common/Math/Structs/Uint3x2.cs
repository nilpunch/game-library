...
{
    [Serializable]
    public partial struct UInt3x2 : IEquatable<UInt3x2>, IFormattable
    {
        public UInt3 c0;
        public UInt3 c1;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator UInt3x2(SoftFloat v)
        {
            return new UInt3x2(v);
        }
        ...
        {
            return string.Format("UInt3x2({0}, {1},  {2}, {3},  {4}, {5})", c0.x.ToString(format, formatProvider),
                c1.x.ToString(format, formatProvider), c0.y.ToString(format, formatProvider),
                c1.y.ToString(format, formatProvider), c0.z.ToString(format, formatProvider),
                c1.z.ToString(format, formatProvider));
        }
    }
    ...
    public static partial class Math
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt3x2 UInt3x2(SoftFloat v)
        {
            return new UInt3x2(v);
        }
        ...
        {
            return SumComponents(v.c0 * UInt3(0x515D90F5u, 0xEC9F68F3u, 0xF9EA92D5u) +
