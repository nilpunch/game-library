...
namespace GameLibrary.Mathematics
{
    public static partial class Math
    {
        ...
        public static SoftFloat FLT_MIN_NORMAL => SoftFloat.FromRaw(0x00800000);
        ...
        public static SoftFloat PI_HALF => SoftFloat.FromRaw(0x3fc90fdb);

        /// <summary>pi / 4. Approximately 0.79.</summary>
        public static SoftFloat PI_OVER_4 => SoftFloat.FromRaw(0x3f490fdb);

        /// <summary>pi * 2. Approximately 6.28.</summary>
        public static SoftFloat TWO_PI => SoftFloat.FromRaw(0x40c90fdb);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SoftFloat lengthsq(SoftFloat x) { return x*x; }

        /// <summary>Returns the squared length of a float2 vector.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SoftFloat lengthsq(float2 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a float3 vector.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SoftFloat lengthsq(float3 x) { return dot(x, x); }

        /// <summary>Returns the squared length of a float4 vector.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SoftFloat lengthsq(float4 x) { return dot(x, x); }
        ...
        /// <summary>Returns the distance between two float2 vectors.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SoftFloat distancesq(float2 x, float2 y) { return lengthsq(y - x); }

        /// <summary>Returns the distance between two float3 vectors.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SoftFloat distancesq(float3 x, float3 y) { return lengthsq(y - x); }

        /// <summary>Returns the distance between two float4 vectors.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SoftFloat distancesq(float4 x, float4 y) { return lengthsq(y - x); }
