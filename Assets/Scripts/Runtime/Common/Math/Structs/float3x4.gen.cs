...
namespace GameLibrary.Mathematics
{
    ...
    public partial struct Float3x4 : System.IEquatable<Float3x4>, IFormattable
    {
        ...
        {
            this.c0 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v);
            this.c1 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v);
            this.c2 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v);
            this.c3 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v);
        }
        ...
        {
            this.c0 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v.c0);
            this.c1 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v.c1);
            this.c2 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v.c2);
            this.c3 = Math.Select(new Float3(SoftFloat.Zero), new Float3(SoftFloat.One), v.c3);
        }
