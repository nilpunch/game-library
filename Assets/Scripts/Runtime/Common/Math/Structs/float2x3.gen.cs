...
namespace GameLibrary.Mathematics
{
    ...
    public partial struct Float2x3 : System.IEquatable<Float2x3>, IFormattable
    {
        ...
        {
            this.c0 = Math.Select(new Float2(SoftFloat.Zero), new Float2(SoftFloat.One), v);
            this.c1 = Math.Select(new Float2(SoftFloat.Zero), new Float2(SoftFloat.One), v);
            this.c2 = Math.Select(new Float2(SoftFloat.Zero), new Float2(SoftFloat.One), v);
        }
        ...
        {
            this.c0 = Math.Select(new Float2(SoftFloat.Zero), new Float2(SoftFloat.One), v.c0);
            this.c1 = Math.Select(new Float2(SoftFloat.Zero), new Float2(SoftFloat.One), v.c1);
            this.c2 = Math.Select(new Float2(SoftFloat.Zero), new Float2(SoftFloat.One), v.c2);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Float2x3(SoftFloat v) { return new Float2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float2x3 operator * (Float2x3 lhs, SoftFloat rhs) { return new Float2x3 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs); }

        /// <summary>Returns the result of a componentwise multiplication operation on a float value and a Float2x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float2x3 operator * (SoftFloat lhs, Float2x3 rhs) { return new Float2x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x3 operator < (Float2x3 lhs, SoftFloat rhs) { return new bool2x3 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs); }

        /// <summary>Returns the result of a componentwise less than operation on a float value and a Float2x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x3 operator < (SoftFloat lhs, Float2x3 rhs) { return new bool2x3 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2); }
    ...
    public static partial class Math
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float2x3 Float2x3(SoftFloat v) { return new Float2x3(v); }
